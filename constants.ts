...
export const LONG_MONEY_PRODUCTS: Product[] = [
  ...
  // Merch
  {
    ...
    category: Category.MERCH,
    price: 25.00,
    description: "Stay warm and rep the brand with this high-quality grey beanie.",
  ...
  },
  {
    ...
    category: Category.MERCH,
    price: 7.00,
    description: "High-quality die-cut sticker to put on your favorite gear.",
    imageUrl: "https://i.imgur.com/s01nTdc.png",
    inStock: true,
  },
];